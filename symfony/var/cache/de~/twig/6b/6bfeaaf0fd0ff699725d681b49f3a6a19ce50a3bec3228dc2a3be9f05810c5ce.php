...
class __TwigTemplate_dd31bc511e14c12c43a31704c255350542b3cd9dc92a1e1362abda5993e7ea5c extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["concert"]) {
            ...
            <h5 class=\"card-title\">concert.tourName</h5>
            <p class=\"card-text\">concert.date</p>
            <p class=\"card-text\">concert.hall</p>
            <a href=\"";
            // line 9
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("list", ["group" => twig_get_attribute($this->env, $this->source, $context["concert"], "id", [], "any", false, false, false, 9)]), "html", null, true);
            echo "\">Afficher</a>
            <a href=\"";
            // line 10
...
";
        ...
        <a href=\"";
        // line 15
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("concert_create");
...
";
    ...
    {
        return array (  97 => 15,  94 => 14,  88 => 13,  83 => 10,  79 => 9,  73 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
